...
if ($categoryId) {
    ...
    if ($dbCat) {
        ...
        $cat = [
            ...
            'teams_count' => $enrichment['teams_count'],
            'active_projects' => $enrichment['active_projects']
        ];
    }
}
        ...
        <div class="container">
            <nav>
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="categories.php" class="active" style="color: var(--primary-color);">Categories</a></li>
